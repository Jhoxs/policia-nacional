...
class AssignVehicleSubcircuitRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'modelSelected' => ['required','array','min:1','exists:App\Models\Vehicle,id'],
    ...
    public function messages(): array
    {
        return [
            ...
            'modelSelected.required' => 'Se debe seleccionar al menos un vehículo',
