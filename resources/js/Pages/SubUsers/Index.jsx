...
const Index = ({ userList, notSubc, haveSubc }) => {


    const dependeces = {
        d_usubcircuits: {
            titleCard: 'Sin Subcircuitos',
            totalCard: notSubc
        },
        d_unotsubcircuits: {
            titleCard: 'Con Subcircuitos',
            totalCard: haveSubc
        },
    ...
    return (
        <>
            <div className='flex justify-end'>
                {permissions.includes('subuser.create') && (
                        <>
                            <Link href={route('subuser.create')}>
                                <Button
                                    type="primary"
                                    size="large"
            ...
            <div className="mt-12 ">
                <SubcircuitsList subcList={userList} />
            </div>
        </>
