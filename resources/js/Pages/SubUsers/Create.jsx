...
const Create = ({ provinces, modelInfo }) => {
    ...
    const onSelectOne = (record, selected, selectedRows) => {
        ...
        if(selected){
            ...
            setData('userSelected',uniqueSelectedRowKeys);
            setLoading(false);
        }else{
            ...
            setLoading(false);
            setData('userSelected',shiftedArray);
        }
    };
    const rowSelection = {
        selectedRowKeys,
        ...
        <>
            <div className="flex items-center mt-2 mb-4">
                <Title level={1} ellipsis>
                    Asignación Usuarios Subcircuito
                </Title>
                ...
                <Card.Grid className='flex justify-center shadow-md' style={{ maxWidth: 800, width: 650, padding: 15, borderRadius: 12 }}>
                    ...
                    >
                        ...
                        <div className="mt-5">
                            ...
                            />
                            <InputError message={errors.userSelected} className="mt-2 text-[#ff4d4f]" />
                        </div>
                        ...
                        <Row justify={'center'} align={'middle'} gutter={['10', '10']} className='mt-4'>
                            ...
                            <Col>
                                {permissions.includes('subuser.store') && (
                                    <>
                                        <Button
                                            type="primary"
                                            htmlType="submit"
