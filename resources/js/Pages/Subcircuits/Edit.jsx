...
const Edit = ({ provinces, subcircuitInfo }) => {

    const { code, display_name, dependences, key} = subcircuitInfo.data;
    ...
    const submit = (e) => {
        // console.log(e);
        patch(route('subcircuit.update',key), {
            onSuccess: () => {
            }
        });
    };
        ...
        <>
            ...
            <div className="flex justify-center mt-5'">
                <Card.Grid className='flex justify-center shadow-md' style={{ maxWidth: 800, width: 550, padding: 15, borderRadius: 12 }}>
                    ...
                    >
                        <Form.Item
                            label='Provincias / Ciudades / Parroquias / Circuitos'
                            name='dependence'
                        ...
                        <Row justify={'center'} align={'middle'} gutter={['10', '10']} className='mt-4'>
                            ...
                            <Col>
                                {permissions.includes('subcircuit.update') && (
                                    <>
                                        <Button
                                            type="primary"
                                            htmlType="submit"
