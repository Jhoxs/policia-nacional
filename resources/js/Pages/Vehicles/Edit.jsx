...
import { IdcardOutlined, FileSearchOutlined, DashboardOutlined, BugOutlined, VerifiedOutlined, PicCenterOutlined, VerticalAlignTopOutlined, SlidersOutlined, TeamOutlined } from '@ant-design/icons';
import dayjs from 'dayjs';

const { Text, Title } = Typography;


const Edit = ({ vehicle_type, vehicleInfo  }) => {

    const vehicle = vehicleInfo?.data;
    ...
    const submit = (e) => {
        patch(route('vehicle.update',vehicle?.key), {
            onSuccess: () => {
            }
        });
    };
...
Edit.layout = page => (<AuthenticatedLayout title="Editar Vehículo" children={page} />)
